...
<body>
  ...
  <?php 
	...
	echo "<a href='$url' style='margin-left:580px;'>Danh sách trạm</a>";
	?>
  
  <h2>Thêm Trạm Dừng</h2>
    <fieldset>
	<?php
	$GLOBALS['idtuyen']=$id = isset($_GET['id']) ? $_GET['id'] : '';
	echo "<input placeholder='Route ID' type='text'  name='routeid' value='$GLOBALS[idtuyen]' disabled >";
	?>
    </fieldset>
    <fieldset>
